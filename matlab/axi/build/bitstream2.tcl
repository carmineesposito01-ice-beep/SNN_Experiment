# Bitstream con ROOT CORTO (evita limite 260-byte path Windows)
set ROOT "D:/zbd"
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 \
  -config { Master "/ps7/M_AXI_GP0" Clk "Auto" } [get_bd_intf_pins snn0/S_AXI]
validate_bd_design
save_bd_design
...
if { [get_property PROGRESS [get_runs impl_1]] == "100%" } {
  open_run impl_1
  set wns [get_property SLACK [lindex [get_timing_paths -max_paths 1 -nworst 1] 0]]
  puts "TIMING_WNS: $wns ns"
}
puts "DONE-BIT"
