...
function s = acc_iidm_r17_description()
  L = {
    ...
    ''
    'ARCHITETTURA R17 (77,936 MHz OOC, +397% vs il baseline combinatorio da 15,7 MHz)'
    '  17 round di pipelining a stadi, tutti bit-exact (campagna hdl_iidm/RESULTS.txt): divisore e radice'
    '  digit-recurrence sequenziali (1-2 bit/ciclo, hardware PIU'' PICCOLO del combinatorio), USE su 4 fasi,'
    '  FINAL/PREP/OU a stadi. E'' l''unica variante che non fa da collo a nessuna configurazione.'
