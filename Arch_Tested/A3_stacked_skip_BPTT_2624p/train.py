# Arch_Tested/A3_stacked_skip_BPTT_2624p/train.py
# Cleanup CLI: --training_method choices ristretta a ['stacked_2_skip'].
...
def main():
    ...
    parser.add_argument('--training_method', type=str, default='stacked_2_skip',
        choices=['stacked_2_skip'],
