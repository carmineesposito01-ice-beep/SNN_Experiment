# Arch_Tested/EVPROP_ALIF_full_864p/train.py
# Cleanup CLI: --training_method choices ristretta a ['eventprop_alif_full'].
# Versione completa (11 varianti) in repository root train.py.
...
def main():
    ...
    parser.add_argument('--training_method', type=str, default='eventprop_alif_full',
        choices=['eventprop_alif_full'],
