# T7b (da T6b · M2) — costruisce il sistema (PS7 + snniidm_axi_lite + SmartConnect) a un dato FCLK, implementa e riporta.
...
#   SRCDIR = cartella CORTA senza spazi coi .vhd + compile_order.txt + snniidm_axi_lite.v (COPIATI dal chiamante:
