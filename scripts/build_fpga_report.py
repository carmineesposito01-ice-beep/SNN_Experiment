...
CAP = {
    ...
    'raster': 'Raster degli spike ordinato per firing-rate, tutti i champion (% attivi/tick fra parentesi). I champion sparano ~13-19% — NON sono iper-sparsi.',
    ...
    'energy_vs_rate': 'Energia vs spike-rate: i pallini marcano il rate operativo reale (~13-19%) — i champion NON sono nel regime iper-sparso.',
